# Navigation Guidelines - withInstruction React Native Project
...
const linking = {
  prefixes: ['withinstruction://', 'withinstruction.page.link//', 'https://withinstruction.page.link'],
...
export const generateDeepLink = (screen: string, params?: any): string => {
  const baseURL = 'https://withInstruction.page.link';
